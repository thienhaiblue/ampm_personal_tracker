...
#define ACCEL_PIN				1
#define ACCEL_IN			(GPIOC_PDIR & (1 << ACCEL_PIN))
...
#define DIS_AU_CMU_EN_PIN		7
#define DIS_AU_CMU_EN_SET		(GPIOC_PSOR = (1 << DIS_AU_CMU_EN_PIN))
#define DIS_AU_CMU_EN_CLR		(GPIOC_PCOR = (1 << DIS_AU_CMU_EN_PIN))
#define DIS_AU_CMU_EN_IN		(GPIOC_PDIR & (1 << DIS_AU_CMU_EN_PIN))
#define DIS_AU_CMU_EN_INIT		PORTC_PCR7 = PORT_PCR_MUX(1); \
											GPIOC_PDDR |= (1 << DIS_AU_CMU_EN_PIN); \
											DIS_AU_CMU_EN_CLR			
											
											
//#define DIS_AU_CMU_EN_PIN		30
//#define DIS_AU_CMU_EN_SET		(GPIOE_PSOR = (1 << DIS_AU_CMU_EN_PIN))
//#define DIS_AU_CMU_EN_CLR		(GPIOE_PCOR = (1 << DIS_AU_CMU_EN_PIN))
//#define DIS_AU_CMU_EN_IN		(GPIOE_PDIR & (1 << DIS_AU_CMU_EN_PIN))
//#define DIS_AU_CMU_EN_INIT		PORTE_PCR30 = PORT_PCR_MUX(1); \
//											GPIOE_PDDR |= (1 << DIS_AU_CMU_EN_PIN); \
//											DIS_AU_CMU_EN_CLR														
...
#define LED_GREEN_PIN_SET_OUTPUT		PORTA_PCR1 = PORT_PCR_MUX(1);GPIOA_PDDR |= (1 << LED_GREEN_PIN)
#define LED_GREEN_PIN_SET_INPUT		PORTA_PCR1 = PORT_PCR_MUX(1);GPIOA_PDDR &= ~(1 << LED_GREEN_PIN)
#define LED_GREEN_PIN_SET					GPIOA_PSOR = (1 << LED_GREEN_PIN)
#define LED_GREEN_PIN_CLR					GPIOA_PCOR = (1 << LED_GREEN_PIN)

#define LED_BLUE_PIN_SET_OUTPUT	PORTB_PCR1 = PORT_PCR_MUX(1);GPIOB_PDDR |= (1 << LED_BLUE_PIN)
#define LED_BLUE_PIN_SET_INPUT		PORTB_PCR1 = PORT_PCR_MUX(1);GPIOB_PDDR &= ~(1 << LED_BLUE_PIN)
#define LED_BLUE_PIN_SET					GPIOB_PSOR = (1 << LED_BLUE_PIN)
#define LED_BLUE_PIN_CLR					GPIOB_PCOR = (1 << LED_BLUE_PIN)

#define LED_RED_PIN_SET_OUTPUT	PORTB_PCR2 = PORT_PCR_MUX(1);GPIOB_PDDR |= (1 << LED_RED_PIN)
#define LED_RED_PIN_SET_INPUT		PORTB_PCR2 = PORT_PCR_MUX(1);GPIOB_PDDR &= ~(1 << LED_RED_PIN)
