...
#define START_Info(...)		//DbgCfgPrintf(__VA_ARGS__)
...
void cpu_identify (void)
{
  uint16 temp;
    ...
    {  
    	case 0x0:
          START_Info("SRAM Size: 0.5 KB\n\r");
    		break;
        case 0x1:
          START_Info("SRAM Size:  1 KB\n\r");
          break;
        case 0x2:
          START_Info("SRAM Size:  2 KB\n\r");
          break;
        case 0x3:
          START_Info("SRAM Size:  4 KB\n\r");
          break;
        case 0x4:
          START_Info("SRAM Size:  8 KB\n\r");
          break;
        case 0x5:
          START_Info("SRAM Size:  16 KB\n\r");
          break;
        case 0x6:
          START_Info("SRAM Size:  32 KB\n\r");
          break;
        case 0x7:
          START_Info("SRAM Size:  64 KB\n\r");
          break;
	default:
  ...
  switch((SIM_FCFG1 & SIM_FCFG1_PFSIZE(0xF))>>SIM_FCFG1_PFSIZE_SHIFT)
    {
  	case 0x0:
    		START_Info("Flash size:  8 KB program flash, 0.25 KB protection region");
    		break;
    	case 0x1:
    		START_Info("Flash size:  16 KB program flash, 0.5 KB protection region	");
    		break;
        case 0x3:
    		START_Info("Flash size:  32 KB program flash, 1 KB protection region	");
    		break;
    	case 0x5:
    		START_Info("Flash size:  64 KB program flash, 2 KB protection region	");
    		break;
        case 0x7:
    		START_Info("Flash size:  128 KB program flash, 4 KB protection region	");
    		break;
        case 0x9:
    		START_Info("Flash size:  256 KB program flash, 4 KB protection region	");
    		break;
        case 0xF:
    		START_Info("Flash size:  128 KB program flash, 4 KB protection region	");
    		break;
	default:
		START_Info("ERR!! Undefined flash size\n\r");  
		break;  	  		
    }
}
/********************************************************************/
...
void flash_identify (void)
{
    ...
    START_Info("Flash parameter version %d ",FTFA_FCCOB4);
    START_Info(" %d ",FTFA_FCCOB5);
    START_Info(" %d ",FTFA_FCCOB6);
    START_Info(" %d\n\r",FTFA_FCCOB7);
    ...
    START_Info("Flash version ID %d ",FTFA_FCCOB4);  
    START_Info(" %d",FTFA_FCCOB5);  
    START_Info(" %d ",FTFA_FCCOB6);  
    START_Info("%d\n\r",FTFA_FCCOB7);  
}
